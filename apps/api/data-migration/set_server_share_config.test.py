...
class SetServerShareConfigTests(unittest.TestCase):
    ...
    def test_updates_latest_config_row(self) -> None:
        with temporary_db_path() as db_path:
            ...
            self.assertEqual(result["current"]["targetVersion"], "Ver.3.5.0F")
            self.assertEqual(result["current"]["dateFrom"], "2026-07-28")
            self.assertEqual(result["current"]["dateTo"], "2026-07-28")
            ...
            self.assertEqual(
                ...
                [
                    ...
                    (2, "Ver.3.5.0F", "2026-07-28", "2026-07-28", 0, 0),
                ],
            )
    ...
    def test_inserts_config_when_table_is_empty(self) -> None:
        with temporary_db_path() as db_path:
            ...
            result = module.set_server_share_config_sqlite(db_path, date_to="2026-07-30")
            ...
            self.assertEqual(row, ("share_v1", "Ver.3.5.0F", "2026-07-28", "2026-07-30", 100))
    ...
    def test_does_not_downgrade_newer_current_version(self) -> None:
        with temporary_db_path() as db_path:
            ...
            with closing(sqlite3.connect(db_path)) as connection:
                with connection:
                    connection.execute(
                        ...
                        SET target_version = 'Ver.3.5.0F', date_from = '2026-07-28', date_to = '2026-07-28'
                        WHERE id = 2
                        """
                    )
            ...
            self.assertEqual(row, ("Ver.3.5.0F", "2026-07-28", "2026-07-28"))
